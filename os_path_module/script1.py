...
print(f"os.getcwd() =  {os.getcwd()}") # absolute path
...
f1 = open(os.path.join(os.getcwd(), "text_file2.txt"), "w")
f1.close()
f2 = open(os.path.join(os.path.dirname(__file__), "text_file2_1.txt"), "w")
f2.close()
